...
def sim(input_name, path):
	...
	def find_gamess(path):
		os.system('locate /gamess/rungms | tee ''/tmp/In_this_crazy_world_of_choices_Ive_only_got_a_few_Either_youre_coming_with_me_or_Im_coming_with_you_Cause_I_finally_found_I_finally_found_you.txt > /dev/null')
