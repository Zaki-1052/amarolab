...
`
    ...
    %s%s    cgcent mol 1
        ...
        pdie 2.0000
        sdie 78.5400
        ion charge -1.00 conc 0.15 radius 1.670
        ion charge 1.00 conc 0.15 radius 1.160
        srfm spl2
        chgm spl2
        sdens 10.00
        srad 1.40
    ...
    space = '1.0'
    fadd = '100'
    inputgenfile = '/soft/pdb2pqr/latest/src/inputgen.py' # change this to a another path if inputgen cannot be called properly
    trash = '/scratch/lvotapka/tmp/'
    ...
    if os.path.exists('apbs_async_all'): # then move it somewhere else
      newname = trash + 'apbs_async_all' + str(int(random.random()*100000))
      print "moving old apbs_async_all folder to the trash:", newname
      os.rename('apbs_async_all', newname)
    os.mkdir('apbs_async_all')
    os.chdir('apbs_async_all')
