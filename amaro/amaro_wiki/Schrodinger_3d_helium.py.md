...
`
    ...
    for level in range(0,arg_level):
      ...
      dx.make_dx("/scratch/lvotapka/projects/helium/quantum_data/phi_sq_%d.dx" % level, phi_sq, nx, ny, nz, hx)
      dx.make_dx("/scratch/lvotapka/projects/helium/quantum_data/phi_%d.dx" % level, phi, nx, ny, nz, hx)
