...
`
    ...
    #TrimerVector modified from TetramerVector
    
    '''
    This script takes a pdb that contains a trimer (or potentially a dimer
    or tetramer with some modification) and finds all equivalent atoms within the
    ...
    filename = '/scratch/lvotapka/projects/h3charge/alignsptraj/hgfalign.pdb'
    chainlen = 503 #for hgf
    monomers = 3 #number of monomers in the molecule
