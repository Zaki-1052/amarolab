...
receptor = u.select_atoms("segid PROA PROB PROC")
...
# Max: 266*1000 + 2*100 + 15 = 266215 (no collisions)
...
seg_colors = {'PROA': '#2c7bb6', 'PROB': '#fdae61', 'PROC': '#d7191c'}

fig, ax = plt.subplots(figsize=(12, 4))
for seg in ['PROA', 'PROB', 'PROC']:
...
# Persistent contacts (>= 0.9 frequency)
