...
OUT  = '/Users/zakiralibhai/Documents/School/biochemcore/charmm-gui-8190629385/analysis/phase5_lipid_order'
...
ax.plot(popc_sn2['positions'], popc_sn2['scd_all'],
        'o-', color='black', markersize=3, linewidth=1, label='All (48)')
