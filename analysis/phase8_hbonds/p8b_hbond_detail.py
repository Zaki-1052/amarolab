# analysis/phase8_hbonds/p8b_hbond_detail.py
#
# Corrected H-bond analysis with explicit donor/acceptor chemistry.
# The previous version used MDAnalysis HydrogenBondAnalysis, which
# misclassified psilocin's C-H groups as H-bond donors (CGenFF atom
# types aren't in its lookup tables), producing ~53 false H-bonds/frame.
# This version defines donors and acceptors from first principles:
# only N-H and O-H groups donate, only N/O/S atoms accept.
