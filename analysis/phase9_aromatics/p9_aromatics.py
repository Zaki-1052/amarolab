# analysis/phase9_aromatics/p9_aromatics.py
...
# ── Ring definitions ─────────────────────────────────────────
# Phenyl rings: 6 atoms (CG CD1 CD2 CE1 CE2 CZ)
# Indole rings: 9 atoms (full fused bicyclic system)
# Note: this measures tilt/wobble of the ring plane (normal
# reorientation). Rotation about the ring's own normal axis
# does not change the normal vector and is not captured here.
# For aromatic rings in a protein pocket, tilt is the dominant
# motion.
