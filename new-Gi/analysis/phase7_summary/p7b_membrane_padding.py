# new-Gi/analysis/phase7_summary/p7b_membrane_padding.py
#
...
PROTEIN_SEL = "segid PROA PROB PROC PROD PROE PROF"
PHOSPHORUS_SEL = "name P and not segid PROA PROB PROC PROD PROE PROF HETA"
...
ax.set_title('Membrane padding — protein clearance (Gi)')
