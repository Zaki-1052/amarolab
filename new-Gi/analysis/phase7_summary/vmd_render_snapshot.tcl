# new-Gi/analysis/phase7_summary/vmd_render_snapshot.tcl
# Renders the 9LL8 (Gi-coupled) 5-HT2A equilibrated snapshot.
...
# Option A
set pdb_file    "5ht2ar_Gi_membrane_snapshot.pdb"
set has_membrane 1
set output_name "Figure_5HT2A_psilocin_Gi_membrane"

# Option B (uncomment these and comment Option A to switch)
# set pdb_file    "5ht2ar_Gi_receptor_psilocin.pdb"
# set has_membrane 0
# set output_name "Figure_5HT2A_psilocin_Gi_receptor"

# Option C
# set pdb_file    "5ht2ar_Gi_receptor_snapshot.pdb"
# set has_membrane 0
# set output_name "Figure_5HT2A_Gi_receptor"
