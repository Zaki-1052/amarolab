# new-Gi/analysis/phase1_visual/vmd_trajectory.tcl
# Loads the 9LL8 (Gi-coupled) 10 ns production trajectory with publication-quality representations.
# Usage: cd to new-Gi/analysis/phase1_visual/, then: source vmd_trajectory.tcl

# ── Per-system configuration ──────────────────────────────────────────────────

set psf_file    "../../charmm-gui-8313215931/openmm/step5_input.psf"
set num_dcds    10
set dcd_prefix  "../../charmm-gui-8313215931/openmm/step7"

set receptor_sel "segname PROE PROF"
set gprotein_sel "segname PROA PROB PROC PROD"
set ligand_sel   "segname HETA"
set lipid_sel    "segname MEMB and noh"

set output_dir   "renders"
set output_name  "trajectory_9LL8_Gi"
...
# Rep 0: receptor cartoon, colored by segment (PROE/PROF each get a color)
...
puts "────────────────────────────────────────────────"
puts "9LL8 (Gi) trajectory loaded: [molinfo top get numframes] frames"
puts ""
puts "Navigation:"
