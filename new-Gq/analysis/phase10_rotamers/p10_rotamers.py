# new-Gq/analysis/phase10_rotamers/p10_rotamers.py
#
# Chi1/chi2 dihedral analysis for binding pocket residues — Gq version.
# Copied from analysis/phase10_rotamers/p10_rotamers.py with path fix.
...
axes[0].set_title('Chi1 dihedral angles — binding pocket residues (Gq)')
fig.tight_layout()
...
axes[-1].set_xlabel('Time (ns)')
axes[0].set_title('Chi2 dihedral angles — binding pocket residues (Gq)')
fig.tight_layout()
...
ax1.set_ylabel('χ1 (°)')
ax1.set_title('W336 (PROC 209) toggle switch (Gq)')
...
fig.suptitle('Side-chain rotamer distributions (χ1 vs χ2, Gq)', fontsize=11)
fig.tight_layout()
